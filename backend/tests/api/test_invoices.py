...
def _patched_upload(client, filepath: str, filename: str = 'invoice.pdf'):
...
class TestUpload:
    ...
    def test_accepts_psf_and_returns_pending(self, client):
        r, _ = _patched_upload(client, '/samples/invoice_cloudhost.pdf')
    ...
    def test_schedules_background_processing(self, client):
        r, mock_process = _patched_upload(client, '/samples/invoice_cloudhost.pdf')
...
class TestListAndDetail:
    ...
    def test_list_after_upload(self, client):
        _patched_upload(client, '/samples/invoice_cloudhost.pdf')
