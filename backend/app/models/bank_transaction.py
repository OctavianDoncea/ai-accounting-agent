...
class ReconciliationRun(Base):
    ...
    created_at: Mapped[list['BankTransaction']] = relationship(back_populates='run', cascade='all, delete-orphan')
...
class BankTransaction(Base):
    ...
    run_id: Mapped[uuid.UUID] = mapped_column(UUID(as_uuid=False), ForeignKey('reconciliation_runs.id', ondelete='CASCADE'), nullable=False, index=True)
